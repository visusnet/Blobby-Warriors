...
#include "TextureLoader2.h"											// Our Header


// Constructor
//
TextureLoader2::TextureLoader2()
{
...
//
void TextureLoader2::SetAlphaMatch(GLboolean fEnabled, GLubyte RedAlphaMatch, GLubyte GreenAlphaMatch, GLubyte BlueAlphaMatch)
{
...
//
void TextureLoader2::SetHighQualityTextures(GLboolean fEnabled)
{
...
//
void TextureLoader2::SetMipMapping(GLboolean fEnabled)
{
...
//
void TextureLoader2::SetTextureFilter(eglTexFilterType type)
{
...
//
int	TextureLoader2::LoadTextureFromDisk(char *szFileName, glTexture *pglTexture)
{
...
//
int	TextureLoader2::LoadTextureFromRam(unsigned char *pData, int Length, glTexture *pglTexture, eglTexType TexType)
{
...
//
int	TextureLoader2::LoadTextureFromResource(unsigned int ResourceName, char *pResourceType, glTexture *pglTexture, eglTexType TexType)
{
	int	rc = FALSE;
...
//
void TextureLoader2::FreeTexture(glTexture *pglTexture)
{
...
//
int TextureLoader2::BuildTexture(char *szPathName, glTexture *pglTexture)
{
...
// Load a TGA file
//
int TextureLoader2::LoadTGAFromDisk(char *pszFileName, glTexture *pglTexture)
{
...
//
int TextureLoader2::LoadJPG_GIFResource(char *pResourceName, char *pResourceType, glTexture *pglTexture)
{
	HDC			hdcTemp;												// The DC To Hold Our Bitmap
	HBITMAP		hbmpTemp;												// Holds The Bitmap Temporarily
	IPicture	*pPicture;												// IPicture Interface
...
int	TextureLoader2::LoadTGAResource(char *pResourceName, char *pResourceType, glTexture *pglTexture)
{
	// from resources
	HRSRC	hRes;
	hRes = FindResource(NULL, pResourceName, pResourceType);
...
//
int TextureLoader2::GenerateTexture(glTexture *pglTexture, GLubyte *pImgData)
{
	int result = 0;
...
// extract the extension from the specified filename
//
void TextureLoader2::ExtensionFromFilename(char *szFileName, char *szExtension)
{
